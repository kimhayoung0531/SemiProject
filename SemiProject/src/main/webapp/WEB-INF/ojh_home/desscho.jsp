                                ...
                                <div class="ojh_left_wing">
                                    ...
                                    <div class="ojh_category-box" >
                                        <ul>
                                            ...
                                            <li class="ojh_li"> 
                                                <a href="http://localhost:9090/SemiProject/desscho.ban">
                                                <span> 초코/캔디</span>
                                                </a>
                                            </li>
                                            <li class="ojh_li"> 
                                                <a href="http://localhost:9090/SemiProject/dessice.ban">
                                                <span> 아이스</span>
                                                </a>
                                            </li>
                                            <li class="ojh_li"> 
                                                <a href="http://localhost:9090/SemiProject/dessmac.ban">
                                                <span> 마카롱</span>
                                                </a>
                                            </li>
                                        </ul>
