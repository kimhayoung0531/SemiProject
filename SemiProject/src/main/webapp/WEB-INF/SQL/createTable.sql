...
CREATE TABLE tbl_order_detail (
	...
	order_name            VARCHAR2(50)  NOT NULL, -- ì£¼ë¬¸?ž?´ë¦?
	...
	recipient_name        VARCHAR2(50)  NOT NULL, -- ?ˆ˜? ¹?ž?´ë¦?
	recipient_mobile      VARCHAR2(20)  NOT NULL, -- ?ˆ˜? ¹?ž?œ´???°ë²ˆí˜¸
	recipient_telephone   VARCHAR2(20)  NULL,     -- ?ˆ˜? ¹?ž?œ ?„ ? „?™”ë²ˆí˜¸
	shipping_address      VARCHAR2(500) NOT NULL, -- ë°°ì†¡ì£¼ì†Œ
	forwarded_message     VARCHAR2(300) NULL,     -- ë¶??ž¬ ?‹œ ? „?‹¬ ë©”ì‹œì§?
	orderer_mobile        VARCHAR2(20)  NOT NULL, -- ì£¼ë¬¸?ž ?œ´???°ë²ˆí˜¸
...
CREATE TABLE tbl_order (
	...
	order_date          DATE         NOT NULL  -- ì£¼ë¬¸?¼?ž
...
CREATE TABLE tbl_cart (
	cart_num      number(20)  NOT NULL, -- ?ž¥ë°”êµ¬?‹ˆë²ˆí˜¸
	user_id       VARCHAR(40) NOT NULL, -- ?•„?´?””
	product_num   number(20)  NOT NULL, -- ?ƒ?’ˆë²ˆí˜¸
	product_count NUMber(15) NOT NULL, -- ?ƒ?’ˆê°œìˆ˜
	cart_date     DATE        NOT NULL  -- ?ƒ?„±?¼?ž
...
create table tbl_inquiry(
   ...
   ,inquiry_date        DATE          NOT NULL -- ?ž‘?„±?‚ ì§?
...
( admin_id   varchar2(40) not null -- ê´?ë¦¬ìž ?•„?´?””
 ,admin_pwd  varchar2(20) not null -- ê´?ë¦¬ìž ë¹„ë?ë²ˆí˜¸
...
( notice_num        number(10)              not null -- ë²ˆí˜¸
 ...
 ,notice_date       date  default  sysdate    not null -- ?ž‘?„±?‚ ì§?
 ,notice_writer     varchar2(10)              not null -- ?ž‘?„±?ž
...
( purchase_review_id   number(10)             not null -- êµ¬ë§¤?›„ê¸°ê?ë²ˆí˜¸
 ...
 ,review_date          date  default  sysdate   not null -- êµ¬ë§¤?›„ê¸°ìž‘?„±?‚ ì§?
...
(
   ...
   post_code           VARCHAR2(5)            NOT NULL, -- ?š°?Ž¸ë²ˆí˜¸
   ...
   registerday         DATE DEFAULT SYSDATE   NOT NULL, -- ê°??ž…?¼?ž
