...
$(document).ready(function() {
   ...
   IMP.request_pay({
       ...
       name : '브레드피트 상품 구매',	 // 코인충전 또는 order 테이블에 들어갈 주문명 혹은 주문 번호. (선택항목)원활한 결제정보 확인을 위해 입력 권장(PG사 마다 차이가 있지만) 16자 이내로 작성하기를 권장
	   ...
	   */
		...
		*/
		...
		//  $(opener.location).attr("href", "javascript:goCoinUpdate('${requestScope.userid}','${requestScope.coinmoney}');");
            ...
            location.href="<%= request.getContextPath()%>/home.ban";
            alert("결제에 실패하였습니다.");
       }
